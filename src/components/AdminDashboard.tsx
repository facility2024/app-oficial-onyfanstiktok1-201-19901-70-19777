...
export const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    const valid = ['home','app','posts','users','roles','creators','cadastros','gamification','marketplace','physical-products','local-businesses','chat-panels','videos','genres','stories-carousel','engagement','intelligent-feed','money','vip','model-subscriptions','webhook-logs','email-events','settings','documentation','video-call','live','ads','promo-ads','feed-promotions','ads-garotas-top','checkout-order-bumps','checkout-page-pix','products','access-pages','product-content'];
