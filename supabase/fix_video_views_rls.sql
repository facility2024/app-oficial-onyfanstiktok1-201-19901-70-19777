...
-- Esta é a política CRÍTICA para permitir que views sejam registradas
...
-- Política 2: Apenas admins podem ler analytics (OPCIONAL)
-- Se quiser permitir leitura pública, comente esta política
