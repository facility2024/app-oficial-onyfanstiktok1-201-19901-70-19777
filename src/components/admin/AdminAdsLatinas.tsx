  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-white">Ads Latinas</h1>
          <p className="text-gray-400">Botão "LATINAS" no topo do feed — 20 por página, com paginação</p>
        </div>
      ...
      {(isCreating || editingId) && (
        <Card className="bg-gray-900 border-pink-500/40">
          <CardHeader>
