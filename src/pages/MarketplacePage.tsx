        ...
        {filteredProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            {filteredProducts.map((product) => (
              <Card
                key={product.id}
                className="cursor-pointer hover:scale-105 transition-transform !bg-gray-900/50 !border-white/10"
              ...
              >
                <CardContent className="p-3">
                  ...
                  {product.stock === 0 && (
                    <p className="text-xs text-red-400 mt-1 font-semibold">Esgotado</p>
                  )}
                </CardContent>
              </Card>
            ))}
