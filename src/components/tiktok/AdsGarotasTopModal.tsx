      ...
      >
        ...
        <div className="relative px-3 sm:px-5 py-8 pb-16">
          <header className="text-center mb-6 sm:mb-10 pt-4">
            ...
            <div
              role="presentation"
              className="mt-4 inline-flex flex-col items-center gap-1 px-5 py-3 rounded-2xl bg-gradient-to-r from-fuchsia-600/40 to-purple-600/40 border border-fuchsia-400/60 shadow-[0_0_25px_rgba(217,70,239,0.5)] cursor-default select-none pointer-events-none"
            >
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-black text-white text-sm sm:text-base bg-gradient-to-r from-cyan-600 to-blue-600 shadow-[0_0_30px_rgba(34,211,238,0.7)] border border-cyan-300/50 animate-cta-attention-purple hover:scale-105 active:scale-95 transition-transform"
              >
