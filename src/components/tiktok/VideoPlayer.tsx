        ...
        {showExternalOverlays && (
          <>
            <div
              ...
              style={{ top: 'calc(env(safe-area-inset-top, 0px) + 12px)' }}
            >
              <span className="flex items-center gap-1.5 shrink-0 whitespace-nowrap px-3 py-1 rounded-full bg-black/70 backdrop-blur-sm border border-white/20 text-white text-xs font-bold shadow-lg">
                <Eye className="w-3.5 h-3.5 text-cyan-300" />
                {formatViews(totalViews)} visualizações
              </span>
              {!isExternallyManaged && (
