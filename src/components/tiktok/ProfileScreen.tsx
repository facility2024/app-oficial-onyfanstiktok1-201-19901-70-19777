            ...
            <div className="mt-6 border-t border-white/10 pt-6 max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap gap-2 mb-6 justify-center">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-white px-4 py-2 rounded-full text-sm hover:opacity-90 transition-opacity font-semibold"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-2 rounded-full text-sm hover:from-green-600 hover:to-emerald-700 transition-all animate-pulse font-semibold"
                >
